    ...
    <div class="col-xl-12 mt-5">
        <div class="row">
            <div class="col-xl-6" id="tpl_title_empresa">
                ...
                <p class="mt-4">
                    <img src="{{ asset('themes/imgs/img_estudantes.jpg') }}" class="img-fluid img-thumbnail" alt="">
                </p>
            </div>
            <div class="col-xl-6" id="tpl_title_empresa">
                ...
                <p class="mt-4">
                    <img src="{{ asset('themes/imgs/img_estudantes_2.jpg') }}" class="img-fluid img-thumbnail" alt="">
                </p>
            </div>
        </div>
    </div>
